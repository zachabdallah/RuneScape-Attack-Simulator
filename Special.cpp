...
void Special::setAdrenalineCost(double n) {
    this->adrenaline_cost = n;
}
void Special::setAdrenalineRequirement(double n) {
    this->adrenaline_requirement = n;
}
double Special::getAdrenalineCost() const {
    return this->adrenaline_cost;
}
double Special::getAdrenalineRequirement() const {
...
Special* Special::copy(Special* class_that_is_passed) {
    Special* new_class = new Special();
