...
void Threshold::setAdrenalineCost(double n) {
    this->adrenaline_cost = n;
}
void Threshold::setAdrenalineRequirement(double n) {
    this->adrenaline_requirement = n;
}
double Threshold::getAdrenalineCost() const {
    return this->adrenaline_cost;
}
double Threshold::getAdrenalineRequirement() const {
...
Threshold* Threshold::copy(Threshold* class_that_is_passed) {
    Threshold* new_class = new Threshold();
